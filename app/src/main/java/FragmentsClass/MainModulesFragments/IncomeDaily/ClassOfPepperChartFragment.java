...
public class ClassOfPepperChartFragment extends Fragment {
    ...
    private void createChart() {
        ...
        colors.add(new PieEntry((calculateWeightFromClassOfPepper("1")),"Klasa 1"));
        colors.add(new PieEntry((calculateWeightFromClassOfPepper("2")),"Klasa 2"));
        colors.add(new PieEntry((calculateWeightFromClassOfPepper("krojona")),"Klasa krojona"));
    ...
    private float calculateWeightFromClassOfPepper(String clas) {
